...
<body>
    <!--==========Main Header==========-->
    <!-- Add the promotional banner section here -->
    <section class="promo_banner" style="background-color: #FFD700;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                          
                    <div class="banner_text">
                        <h2>Round Trips to the Moon</h2>
                        <p>Departure every Monday!</p>                            
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- The promotional banner section ends here -->
    <!--==========Main Header==========-->
